...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
      <div className="max-w-screen-xl mx-auto px-4 py-10 w-full md:py-16">
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-8 border-t border-gray-500 text-center text-base text-gray-500">
